package ijex.liminality.item.custom;

import com.google.common.collect.ImmutableMap;
import ijex.liminality.item.ModArmorMaterials;
...
public class DivingArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ModArmorMaterials.DIVING, new StatusEffectInstance(StatusEffects.WATER_BREATHING, 1, 0,
                            false, false, false)).build();
    public DivingArmorItem(ArmorMaterial material, Type type, Settings settings) {
